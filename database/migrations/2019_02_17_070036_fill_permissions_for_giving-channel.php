...
class FillPermissionsForGivingChannel extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForGivingChannel constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.giving-channel',
            'admin.giving-channel.index',
            'admin.giving-channel.create',
            'admin.giving-channel.show',
            'admin.giving-channel.edit',
            'admin.giving-channel.delete',
        ]);
