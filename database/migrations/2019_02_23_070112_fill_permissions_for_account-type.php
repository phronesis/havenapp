...
class FillPermissionsForAccountType extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAccountType constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.account-type',
            'admin.account-type.index',
            'admin.account-type.create',
            'admin.account-type.show',
            'admin.account-type.edit',
            'admin.account-type.delete',
        ]);
