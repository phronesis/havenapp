...
class FillPermissionsForGivingRecord extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForGivingRecord constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.giving-record',
            'admin.giving-record.index',
            'admin.giving-record.create',
            'admin.giving-record.show',
            'admin.giving-record.edit',
            'admin.giving-record.delete',
        ]);
