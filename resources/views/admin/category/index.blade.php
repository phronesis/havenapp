                        ...
                        <table class="table table-hover table-listing">
                            <thead>
                                <tr>
                                    ...
                                    <th is='sortable' :column="'category'">{{ trans('admin.category.columns.category') }}</th>
                                    <th is='sortable' :column="'active'">{{ trans('admin.category.columns.active') }}</th>
                                    <th is='sortable' :column="'account_types_id'">{{ trans('admin.category.columns.account_types_id') }}</th>
