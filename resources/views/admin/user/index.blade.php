                        ...
                        <table class="table table-hover table-listing">
                            <thead>
                                <tr>
                                    ...
                                    <th is='sortable' :column="'lastname'">{{ trans('admin.user.columns.lastname') }}</th>
                                    ...
                                    <th is='sortable' :column="'chapters_id'">{{ trans('admin.user.columns.chapters_id') }}</th>
